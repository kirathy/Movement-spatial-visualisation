...
void gweekend()
{
  ...
  if (ji >= 0 && ji < 24)
  {
    for (int jj = 0; jj < 7; jj++)
    {
      ...
      triangle(w1, h1, w1+cos((jj+1)*TWO_PI/7)*radiu*((dat1+offset1*i)/144), h1+sin((jj+1)*TWO_PI/7)*radiu*((dat1+offset1*i)/144), w1+cos((jj+2)*TWO_PI/7)*radiu*((dat3+offset2*i)/144), h1+sin((jj+2)*TWO_PI/7)*radiu*((dat3+offset2*i)/144));
    }
  }
}
/********************************************************************
...
void gweekday()
{
  ...
  if (ji >= 0 && ji < 24)
  {
    for (int jj = 0; jj < 7; jj++)
    {
      ...
      float offset2 = (dat4 - dat3)/(1200/speed); //100 speed
      int i = (runtimes % 1200)/speed; //100 speed
      triangle(w2, h2, w2+cos((jj+1)*TWO_PI/7)*radiu*((dat1+offset1*i)/247), h2+sin((jj+1)*TWO_PI/7)*radiu*((dat1+offset1*i)/247), w2+cos((jj+2)*TWO_PI/7)*radiu*((dat3+offset2*i)/247), h2+sin((jj+2)*TWO_PI/7)*radiu*((dat3+offset2*i)/247));
    }
  }
}
/********************************************************************
